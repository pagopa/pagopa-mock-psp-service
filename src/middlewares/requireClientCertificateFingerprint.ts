...
export function requireClientCertificateFingerprint(validFingerprint: string): express.Handler {
  return (req: express.Request, res: express.Response, next: express.NextFunction) => {
    try {
      ...
      if (clientCertificateBase64 !== undefined && clientCertificateBase64 !== '') {
